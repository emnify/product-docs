...
> [!IMPORTANT]
> Make sure you have **v3.0.0 or higher** to match the existing directory structure and the version running in the CI pipeline.
...
Vale uses [Vocabularies](https://vale.sh/docs/topics/vocab/) to define term lists to customize styles further.
emnify uses this to define company or industry-specific terminology that a traditional spell check misinterprets.

- [`accept.txt`](./styles/config/vocabularies/emnify/accept.txt) - acceptable formatting and spelling
- [`reject.txt`](./styles/config/vocabularies/emnify/reject.txt) - deprecated company terminology or common mistakes
