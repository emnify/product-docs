...
## Company account
A company's emnify account.
Also referred to as the **Organization** in the Portal.

:::note
Every company account (i.e., the [Organization](#organization)) on the [**Pro** plan](https://portal.emnify.com/organisation-settings/subscription#plans) is a [Workspace](#workspace) by default.
:::
...
## Main organization
The main account ([Workspace](#workspace)) from which multiple Workspaces can be managed.

_Also see [organization](#organization)._
...
## Organization
The company (or subsidiary, branch, division, department, etc.) associated with a [Workspace](#workspace).

_Also see [main organization](#main-organization)._
...
## User account
The account associated with a specific person, used to log in to one or more [Workspaces](#workspace).
...
## Workspace
An independent Portal entity associated with an Organization.
A Workspace can be independently managed, or be [centrally managed](#linked-workspaces) while being billed and accessed separately.

:::note
Every [company account](#company-account) (i.e., the [Organization](#organization)) on the [**Pro** plan](https://portal.emnify.com/organisation-settings/subscription#plans) is a Workspace by default.
:::

## Workspace switcher
The Portal feature that allows you to switch between [Workspaces](#workspace).
