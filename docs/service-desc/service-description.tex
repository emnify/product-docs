...
\addspace
\begin{figure}[h]
  \includegraphics[width=15cm, center]{portal-device-policies-breakout-regions}
  \removespace
...
\addspace
\begin{figure}[h]
  \includegraphics[width=15cm]{portal-dashboard}
  \removespace
...
\addspace
\begin{figure}
  \includegraphics[width=15cm]{workspaces}
  \removespace
  \caption{Workspaces}
\end{figure}
\addspace
...
\addspace
\begin{figure}[h]
  \includegraphics[width=10cm, center]{vpn-options-and-public-breakout}
  \removespace
