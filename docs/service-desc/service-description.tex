...
\fancyfoot[L]{
  ...
  \textsc{emnify GmbH --- Confidential \& Proprietary}
  }\fancyfoot[R]{\thepage}
\pagestyle{fancy}
\thispagestyle{empty}
...
\hline
\multicolumn{3}{|l|}{} & \multicolumn{1}{c|}{\textbf{Commercial eUICC}} & \multicolumn{1}{l|}{\textbf{Industrial eUICC}} & \multicolumn{1}{c|}{\textbf{MFF2}} \\ \hline
\multicolumn{1}{|l|}{\multirow{15}{*}{\textbf{\begin{tabular}[c]{@{}l@{}}Hardware\\ characteristics\end{tabular}}}} & \multicolumn{1}{l|}{\multirow{2}{*}{\textbf{Form Factor}}} & Embedded/solderable & \multicolumn{1}{c|}{-} & \multicolumn{1}{c|}{-} & \multicolumn{1}{c|}{MFF2} \\ \cline{3-6} 
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & Removable Card & \multicolumn{1}{c|}{Triple-cut or Dual-Cut} & \multicolumn{1}{c|}{2FF or 3FF} & \multicolumn{1}{c|}{-} \\ \cline{2-6} 
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{\multirow{5}{*}{\textbf{Chip Type}}} & \begin{tabular}[c]{@{}l@{}}Operational and\\ storage temperature\end{tabular} & \multicolumn{1}{l|}{–25°C to +85°C (JESD22-A104)} & \multicolumn{2}{c|}{–40°C to +105°C (JESD22-A104)} \\ \cline{3-6} 
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & Operating voltage & \multicolumn{3}{c|}{1.62V to 5.5V} \\ \cline{3-6} 
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & Interface & \multicolumn{3}{c|}{ISO-7816, T=0} \\ \cline{3-6} 
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & Chipset NVM size & \multicolumn{3}{c|}{704 Kbytes} \\ \cline{3-6} 
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & Chipset RAM size & \multicolumn{3}{c|}{20 Kbytes} \\ \cline{2-6} 
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{\multirow{8}{*}{\textbf{\begin{tabular}[c]{@{}l@{}}NVRAM\\ characteristics\end{tabular}}}} & Write Endurance & \multicolumn{3}{c|}{500k erase per page 10M cycles with OS High Endurance} \\ \cline{3-6} 
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & Data retention & \multicolumn{3}{c|}{15 years @85°C} \\ \cline{3-6} 
