---
description: Send or receive SMS via the emnify Portal, use the SMS APIs, or integrate Zapier
last_update:
  date: 01-17-2024
slug: /services/sms
---
...
You can also open the SMS console directly from the Connected Devices table.
