...
<table className="table">
  ...
  <tbody>
    <tr>
      <td rowSpan="15" className="table__td">Hardware characteristics</td>
      <td rowSpan="2" className="table__td">Form Factor</td>
      <td className="table__td">Embedded/solderable</td>
      <td className="table__td table__td--align-center">—</td>
      <td className="table__td table__td--align-center">—</td>
      <td className="table__td table__td--align-center">MFF2</td>
    </tr>
    <tr>
      <td className="table__td">Removable Card</td>
      <td className="table__td">Triple-cut or Dual-Cut</td>
      <td className="table__td">2FF or 3FF</td>
      <td className="table__td table__td--align-center">—</td>
    </tr>
    <tr>
      <td rowSpan="5" className="table__td">Chip Type</td>
      <td className="table__td">Operational and storage temperature</td>
      <td className="table__td">-25°C to +85°C (JESD22-A104)</td>
      <td colSpan="2" className="table__td table__td--align-center">-40°C to +105°C (JESD22-A104)</td>
    </tr>
    <tr>
      <td className="table__td">Operating voltage</td>
      <td colSpan="3" className="table__td table__td--align-center">1.62V to 5.5V</td>
    </tr>
    <tr>
      <td className="table__td">Interface</td>
      <td colSpan="3" className="table__td table__td--align-center">ISO-7816, T=0</td>
    </tr>
    <tr>
      <td className="table__td">Chipset NVM size</td>
      <td colSpan="3" className="table__td table__td--align-center">704 kilobytes</td>
    </tr>
    <tr>
      <td className="table__td">Chipset RAM size</td>
      <td colSpan="3" className="table__td table__td--align-center">20 kilobytes</td>
    </tr>
    <tr>
      <td rowSpan="8" className="table__td">NVRAM characteristics</td>
      <td className="table__td">Write Endurance</td>
      <td colSpan="3" className="table__td">500k erase per page 10M cycles with OS High Endurance</td>
    </tr>
    <tr>
      <td className="table__td">Data retention</td>
      <td colSpan="3" className="table__td table__td--align-center">15 years @85°C</td>
    </tr>
    <tr>
      <td className="table__td">Moisture/Reflow conditions</td>
      <td className="table__td table__td--align-center">—</td>
      <td colSpan="2" className="table__td">MSL3 (J-STD020)</td>
    </tr>
    <tr>
      <td className="table__td">Humidity</td>
      <td className="table__td table__td--align-center">—</td>
      <td colSpan="2" className="table__td">HA as per ETSI TS 102.671 / (JESD22-A101D)</td>
    </tr>
    <tr>
      <td className="table__td">Corrosion</td>
      <td className="table__td table__td--align-center">—</td>
      <td className="table__td table__td--align-center">—</td>
      <td className="table__td">CX as per ETSI TS 102.671 (JESD22-A107)</td>
    </tr>
    <tr>
      <td className="table__td">Vibration</td>
      <td className="table__td table__td--align-center">—</td>
      <td className="table__td table__td--align-center">—</td>
      <td className="table__td">VX as per ETSI TS 102.671 (JESD22-B103)</td>
    </tr>
    <tr>
      <td className="table__td">Shock</td>
      <td className="table__td table__td--align-center">—</td>
      <td className="table__td table__td--align-center">—</td>
      <td className="table__td">SX as per ETSI TS 102.671 (JESD22-B104)</td>
    </tr>
    <tr>
      <td className="table__td">Common Criteria Certificate</td>
      <td colSpan="3" className="table__td table__td--align-center">CCN-CC-5/2019</td>
    </tr>
  </tbody>
</table>
