...
- **Triggers for custom business processes** (e.g., authentication or custom usage limitations configured on the [emnify Portal](/emnify-system-events-usage#emnify-portal))
...
:::info
Any events triggered in the [emnify Portal](/emnify-system-events-usage#emnify-portal) will show **API** as the event source. 
...
The [Event Types](/emnify-system-events-event-types) page provides an overview of the specific events generated by our platform.

## Working with events

There are three main ways you can access and trigger events: 

- [Data Streamer](/emnify-system-events-usage#data-streamer)
- [Event API](/emnify-system-events-usage#event-api) 
- [emnify Portal](/emnify-system-events-usage#emnify-portal)

More information on these systems and how they compare is available on the [Work with events](/emnify-system-events-usage) page.
