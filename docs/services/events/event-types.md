...
slug: /emnify-system-events-event-types
---
...
If successful, the device will appear as **Attached** in the [emnify Portal](/emnify-system-events-usage#emnify-portal) and will be ready to receive SMS.
...
Once executed, the [connectivity status](/glossary#connectivity-status) will appear as **Offline** in the [emnify Portal](/emnify-system-events-usage#emnify-portal).
...
This device will appear as **Online** in the [emnify Portal](/emnify-system-events-usage#emnify-portal) as long as there hasn't been a subsequent [Delete PDP Context](#delete-pdp-context) event.
...
The event details will also show the data transmitted, and the device will appear as **Attached** in the [emnify Portal](/emnify-system-events-usage#emnify-portal).
...
You can manually trigger this event by using the [emnify Portal or REST API](/emnify-system-events-usage).
...
:::info
Triggered through the [emnify User Interface (EUI)](https://support.emnify.com/hc/en-us/sections/115000969189-emnify-User-Interface-EUI-) or [REST API](/emnify-system-events-usage#event-api).
:::
