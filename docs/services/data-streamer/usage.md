...
slug: /emnify-multicloud-data-streamer-usage
---
...
To [manage your data streams](/emnify-multicloud-data-streamer-manage-data-streams), [log in to your emnify Portal account](https://portal.emnify.com/sign/).
...
If there are no data streams configured, the [**Data Streams**](https://portal.emnify.com/integrations#data-streams) panel displays all available [connection types](/emnify-multicloud-data-streamer-connection-types) as tiles.
...
Configure the source by selecting your desired [stream type](/emnify-multicloud-data-streamer-stream-types).
Optionally, you can add event options for [filtering on event types](/emnify-multicloud-data-streamer-manage-data-streams#filter-event-data-streams).
...
Instructions for configuring each connection type are in the [Available integrations](/emnify-multicloud-data-streamer-integrations) section.
:::
...
With the **Details** button on the Data Stream tiles, you can inspect the configuration and update the [filters for event data streams](/emnify-multicloud-data-streamer-manage-data-streams#filter-event-data-streams).
...
:::caution
API keys and configuration parameters differ by [connection type](/emnify-multicloud-data-streamer-connection-types).
...
The following JSON request body example shows how to create a stream of usage data records with the [Webhook integration](/emnify-multicloud-data-streamer-integrations#webhook):
...
You can also create an event stream with [AWS Kinesis integration](/emnify-multicloud-data-streamer-integrations#amazon-kinesis-data-streams) and enabled filtering, like the following JSON request body example:
