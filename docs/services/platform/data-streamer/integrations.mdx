...
<Image
  srcPath={require('./assets/aws-s3-bucket-permissions-blocking-public-access.png').default}
...
<Image
  srcPath={require('./assets/aws-s3-bucket-properties-encryption.png').default}
