...
4. Make sure you're on the **Linux** tab, then click **Download client.conf**.

<img
  src={require('./assets/portal-integrations-secure-connections-openvpn-linux-download.png').default}
  alt=""
/>
...
<img
  src={require('./assets/portal-integrations-secure-connections-openvpn-linux-download-dropdown.png').default}
  alt=""
  style={{ height: 400 }}
/>
