...
4. Make sure you're on the **Windows** tab, then click **Download client.ovpn**.

<img
  src={require('./assets/portal-integrations-secure-connections-openvpn-windows-download.png').default}
  alt=""
/>
...
<img
  src={require('./assets/portal-integrations-secure-connections-openvpn-windows-download-dropdown.png').default}
  alt=""
  style={{ height: 400 }}
/>
