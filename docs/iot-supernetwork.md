...
- **New to emnify?**
Follow our [getting started guide](/quickstart).
- **Want to learn more about what the SuperNetwork can do?** Explore our available [services](/services).
- **Looking for APIs and SDKs?**
Check out our [developer resources](/rest).
- **Using the [emnify Portal](/portal)?**
We have [how-to guides](/how-tos) for configuring your account, managing devices, and more.
- **Too many acronyms?** 
Find definitions and examples in our [glossary](/glossary).
