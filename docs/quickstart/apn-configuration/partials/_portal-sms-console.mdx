First, turn on your {props.deviceType} and ensure the device and emnify SIM card are activated.
...
2. Navigate to **Connected Devices** and find your {props.name} {props.deviceType}.
Turning on the {props.deviceType} for the first time after installing the SIM shows the status as **Attached**.
