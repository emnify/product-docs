...
<PortalSmsConsolePartial name="Teltonika" alternateCommandPrompt="command corresponding to your device settings." />
...
<PortalSmsConsolePartial name="Ruptela" />
...
<PortalSmsConsolePartial name="Concox" />
...
<PortalSmsConsolePartial name="Coban" alternateCommandPrompt="following commands." />
...
<PortalSmsConsolePartial name="Meitrack" />
...
<PortalSmsConsolePartial name="Elinz" alternateCommandPrompt="command corresponding to your device model." />
...
<PortalSmsConsolePartial name="ReachFar" alternateCommandPrompt="command corresponding to your device model." />
...
<PortalSmsConsolePartial name="Queclink" />
...
<PortalSmsConsolePartial name="Bitrek" />
