...
You can use the same email address to join as many Workspaces as you're invited to by an **Administrator**, but you may have different [user roles](/portal/roles) in each Workspace.
...
1. Check your inbox for an email invitation from emnify.
1. Click **Accept Invitation** to access the web interface.
  If you're redirected to your existing Workspace, log out and try to accept the invitation again.
