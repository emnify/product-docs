...
:::tip
For more information about locating your BIC, see [I can't register SIM cards](https://support.emnify.com/hc/en-us/articles/360019254640-I-cannot-register-my-SIM-cards-The-BIC-code-is-invalid-or-I-do-not-have-a-BIC-code) on the Knowledge Base.
:::
...
Activating the SIM and creating a connected device during registration is recommended.
:::
