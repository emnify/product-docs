...
1. Click **Edit** (pencil icon) to open the configuration modal.
...
1. Click **Edit** (pencil icon) to open the configuration modal.
1. Edit the **Primary NS** or **Secondary NS** field, then click **&#10003; Confirm** to save your changes.
...
1. In **Data**, find the **Custom DNS Server** section.
  The badge next to the section title should read **Configured DNS**.
1. Click **Edit** (pencil icon) to open the configuration modal.
1. Remove the values from the **Primary NS** and **Secondary NS** fields, then click **&#10003; Confirm** to save your changes.
