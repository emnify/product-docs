...
<Image
  srcPath={require('./assets/portal-connected-devices-details-button.png').default}
/>
...
<Image
  srcPath={require('./assets/portal-connected-devices-details-device-policies-coverage-policy-edit-button.png').default}
/>
...
<Image
  srcPath={require('./assets/portal-connected-devices-details-device-policies-coverage-policy-dropdown.png').default}
...
<Image
  srcPath={require('./assets/portal-connected-devices-bulk-actions-more-change-coverage-policy.png').default}
/>
...
<Image
  srcPath={require('./assets/portal-connected-devices-bulk-actions-change-coverage-policy-modal.png').default}
/>
