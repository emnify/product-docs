...
1. Find the service policy where you want to turn on quota management and expand the policy details.
1. In **Data** or **SMS**, click the **Data Quota** or **SMS Quota** toggle to the on position.
1. Read the prompt about setting up a specific quota per device, then click **Confirm**.
...
1. Navigate to the [**Service Policies**](https://portal.emnify.com/device-policies#service-policies) section of **Device Policies**.
1. Find the service policy where you want to turn off quota management and expand the policy details.
1. In **Data** or **SMS**, click the **Data Quota** or **SMS Quota** toggle to the off position.
