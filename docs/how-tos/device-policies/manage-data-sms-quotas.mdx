...
<img
  ...
  alt="Modal that appears after you click a quota toggle. It reads, 'Enabling quota management blocks all devices of this service policy from SMS and data usage until you set up a specific contingent per device in the device details.'"
  style={{ width: 450 }}
/>
