...
<Image
  srcPath={require('./assets/portal-connected-devices-details.png').default}
/>

4. Locate the **Blocked Operators** section and click **Edit**.

<Image
  srcPath={require('./assets/portal-device-details-general-status-blocked-operators-empty-edit.png').default}
...
<Image
  srcPath={require('./assets/portal-device-details-general-blocked-operators-networks-blocklist-dropdown.png').default}
...
<Image
  srcPath={require('./assets/portal-device-details-general-status-blocked-operators-two.png').default}
  modifiers="img--width-350"
/>
...
<Image
  srcPath={require('./assets/portal-device-details-general-status-blocked-operators-edit.png').default}
  modifiers="img--height-500"
/>
...
<Image
  srcPath={require('./assets/portal-device-details-general-status-blocked-operators-networks-blocklist-remove.png').default}
  modifiers="img--width-350"
/>
...
<Image
  srcPath={require('./assets/portal-device-details-general-status-blocked-operators.png').default}
  modifiers="img--width-350"
/>
...
<Image
  srcPath={require('./assets/portal-connected-devices-select-multiple-devices.png').default}
/>
...
<Image
  srcPath={require('./assets/portal-connected-devices-bulk-actions-more-block-operators.png').default}
/>
...
<Image
  srcPath={require('./assets/portal-connected-devices-bulk-actions-networks-blocklist-modal-dropdown.png').default}
...
<Image
  srcPath={require('./assets/portal-connected-devices-bulk-actions-networks-blocklist-modal-save.png').default}
  modifiers="img--width-450"
/>
