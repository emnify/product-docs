...
<Image
  srcPath={require('./assets/portal-connected-devices-details-sms-console.png').default}
...
<Image
  srcPath={require('./assets/portal-connected-devices-sms-bulk-send.png').default}
/>
...
<Image
  srcPath={require('./assets/portal-send-sms-message-text.png').default}
