...
<img
  className="img"
  src={require('./assets/portal-integrations-ip-address-space-management-add-ip-address-space.png').default}
  alt=""
/>
...
<img
  ...
  src={require('./assets/portal-integrations-ip-address-space-management-add-ip-address-space-dropdown.png').default}
  alt=""
/>
...
<img
  className="img"
  src={require('./assets/portal-integrations-ip-address-space-management-ranges.png').default}
  alt=""
/>
...
<img
  className="img"
  src={require('./assets/portal-integrations-ip-address-space-management-delete.png').default}
  alt=""
/>
