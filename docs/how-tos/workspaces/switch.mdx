...
One benefit of having linked workspaces is that you can manage multiple independent entities using one emnify account.

This guide shows you how to switch between your workspaces via the workspace switcher in the emnify Portal.

<PermissionsInfoPartial action="switch between" />
