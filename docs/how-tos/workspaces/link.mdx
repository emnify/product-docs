...
If you already have two or more workspaces created, you can link these workspaces and manage them using one emnify account.
...
Once linked, invited **Administrator** user accounts are able to [switch between workspaces](/workspaces/switch).
