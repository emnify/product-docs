...
<Image
  srcPath={require('./assets/portal-connected-devices-search.png').default}
/>
...
<details className="details details--info">
  ...
  <Image
    srcPath={require('./assets/portal-connected-devices-bulk-enable-disable.png').default}
  />
</details>
...
<details className="details details--info">
  <summary>Show where this happens in the Portal</summary>
  <Image
    srcPath={require('./assets/portal-connected-devices-reset-connectivity.png').default}
  />
  <Image
    srcPath={require('./assets/portal-device-details-reset-connectivity.png').default}
