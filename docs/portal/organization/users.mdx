...
1. On [**Users**](https://portal.emnify.com/organisation-settings/users), find the user you want to remove from the Workspace and click **Edit** (pencil icon).
1. Select **Add to Workspace**.
1. In the **Workspace** list, choose an option and click **✓ Confirm**.

### Delete an existing user

1. On [**Users**](https://portal.emnify.com/organisation-settings/users), find the user you want to remove from the Workspace and click **Edit** (pencil icon).
1. Click **More** (vertical dots icon) next to the Workspace name.
