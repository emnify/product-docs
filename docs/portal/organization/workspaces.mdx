...
| Reports <span className="badge">Coming soon</span> | <Close alt="No" />  | <Check alt="Yes" /> |
...
There is only one SuperAdmin per main organization, and users with this role can't be removed from any Workspace linked to that organization, as they're the assumed owner.
