...
<Image
  srcPath={require('./assets/infographic-eid-digits.png').default}
...
<Image
  srcPath={require('./assets/infographic-iccid-digits.png').default}
...
<details className="details details--example">
  ...
  <Image
    srcPath={require('./assets/imsi-components-table.png').default}
