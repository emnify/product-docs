...
<Image
  srcPath="https://user-images.githubusercontent.com/25433336/225385087-37c5fa5c-4b23-4fca-a1b5-675974392473.png"
/>
...
<Image
  srcPath={require('./assets/graphiql-sidebar-show-documentation-explorer-button.png').default}
...
<Image
  srcPath={require('./assets/graphiql-docs-query-myuser.png').default}
...
<Image
  srcPath={require('./assets/graphiql-docs-query-myuser-user.png').default}
  modifiers="img--width-700"
/>
...
<Image
  srcPath={require('./assets/graphiql-docs-query-myuser-user-organisation.png').default}
  modifiers="img--width-700"
/>
...
<Image
  srcPath={require('./assets/graphiql-default-query-response.png').default}
/>
...
<Image
  srcPath={require('./assets/graphiql-query-autocomplete.png').default}
...
<Image
  srcPath={require('./assets/graphiql-sidebar-show-graphiql-explorer-button.png').default}
  modifiers="img--width-450"
/>
...
<Image
  srcPath={require('./assets/graphiql-graphiql-explorer-endpoints.png').default}
  modifiers="img--width-700"
/>
...
<Image
  srcPath={require('./assets/graphiql-sidebar-show-history-button.png').default}
  modifiers="img--width-350"
/>
...
<Image
  srcPath={require('./assets/graphiql-default-generate-code-buttons.png').default}
  modifiers="img--width-450"
/>
