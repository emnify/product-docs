...
const files = [
  ...
  "emnify-iot-esim.html",
  "emnify-iot-supernetwork.html",
  "emnify-connectivity-platform.html",
  "communication-services.html",
  "network-security-services.html",
  "emnify-premium-services.html",
  "support.html",
];
  ...
  lines.split(/\r?\n/).forEach(line => {
    ...
    if (keep) {
      if (!line.match(/<details/) && !line.match(/<\/details/)) {
        if (line.match(/<span class="pagebreak"/)) {
          line = line.replace(/<span class="pagebreak"><\/span>/, pageBreak);
